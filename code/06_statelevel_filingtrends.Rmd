...
dph_tse$dph_tse_rate <- dph_tse$DUE_PROCESS_COMPLAINTS_DPC_TOTAL / dph_tse$"STUDENT COUNT" * 100


dph_iep <- merge(dph_tse, iep_analytic, by=c('YEAR','STATE'))

dph_iep$AGE.3.TO.21 <- as.numeric(gsub(",","",dph_iep$AGE.3.TO.21))
dph_iep$dph_iep_rate <- dph_iep$DUE_PROCESS_COMPLAINTS_DPC_TOTAL / dph_iep$AGE.3.TO.21 * 100
